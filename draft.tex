...
In 1959 the two mathematicians Paul Erd\H{o}s and Alfr\'{e}d R\'{e}nyi proposed a model to generate random networks \cite{F.Costa2007}. Idependently of them, Solomonoff and Rapoport already proposed the model in 1951. The model constructs random networks with $N$ nodes in the following way \cite{Albert2002}
\begin{enumerate}
...
\end{equation}
and thus the probability of being connected to $k$ other nodes becomes
\begin{equation}
