...
\begin{figure}[h]
\centerline{\includegraphics[width=14cm, height=10cm]{echo_chamber_vs_stubbornness_SBM_WS_fracStubb_PR.png}}
\caption{This is an image from a text that uses color to teach music. Make really really long caption, as long as textwidth}
