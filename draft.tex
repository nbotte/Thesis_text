...
\newline
In Fig. \ref{echo_vs_fracRes_real_PGP} the formation of echo chambers versus the fraction of completely stubborn actors is studied for the real-world PGP trust network and for the corresponding network models. This is done for both the PR and REC filtering algorithms. \\
\newline
