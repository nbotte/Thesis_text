...
Once again, the opinion dynamics model described in Chapter \ref{chap4}, Section \ref{opinionmodel} is implemented with a activation probability equal to $p_{\text{act}} = 0.1$ and a maximum length of the actual time-line $S = 20$.
...
\end{figure}
% don't forget the evolution of opinions!!
\noindent
