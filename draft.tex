...
They are also referred to as scale-free networks, since they do not posses a characteristic length scale or, in this case, the average degree isn't a characteristic scale for the network. % correct statement?
...
% talk about difference transitivity and clustering + read https://arxiv.org/pdf/cond-mat/0505185.pdf
 
\cite{Albert2002} % not used yet, explains statistical mechanics in complex networks
