...
% NOT FOR HERE, but maybe in section over future recommendations, ways forward: talk about need to investigate different activation mechanisms, maybe model where actors can make new friends and remove old friends (at a time rate comparable to the time rate of the opinion dynamics and also maybe based on the opinions of the friends, e.g. if a friend has an opinion far from your, you might be more likely to defriend that one and, vice versa, you might be more likely to become new friends with somebody who has an opinion close to yours)
