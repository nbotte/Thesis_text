...
We will first discuss the formation of echo chambers for an initial $50/50$ opinion distribution, after which the results for the opinion evolution will be shared.
...
\end{figure}
% don't forget the evolution of opinions + also for 20/80, do each network, PR, REC, REF for eg. stubb 0.4 (so two fig (50-50 and 20-80) with 4 subplots (one for each network), each plot has PR, REF, REC) + if all stubb frac behaves same, explain in text, if not make extra plot!!
\newpage
\noindent
...
\end{figure}
% explain ev of op figures + make link to those with frac compl stubb
...
% make link to figures op frac+ hampering PR + network structures!!
