...
\begin{itemize}
	...
	\item An initial $20/80$ opinion distribution: the initial fraction of nodes with opinion 0 is equal to $P_0(0) = 0.2$ and the initial fraction of nodes with opinion 1 is equal to $P_1(0) = 0.8$
\end{itemize}
